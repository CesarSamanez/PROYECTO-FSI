			...
			<div class="row">
				<div class="col-xs-12 col-sm-6 hidden-xs">
					...
					<p class="lead text-center">
						Gestiona tus anuncios, tus favoritos, compra y vende cuando y desde dónde quieras
					</p>
				...
				<div class="col-xs-12 col-sm-6">
					<div class="full-width container-login">
						...
						<form action="insertUser.php" method="POST">
							<div class=" form-group">
								<input type="text" name="nombres" minlength="1" maxlength="30"
									class="form-control input-lg" placeholder="Nombres" required pattern="[A-Z|a-z| ]+"
									title="El campo solo debe contener letras.">
							</div>

							<div class="form-group">
								<input type="text" name="apellidos" minlength="1" maxlength="30"
									class="form-control input-lg" placeholder="Apellidos" required
									pattern="[A-Z|a-z| ]+" title="El campo solo debe contener letras.">
							</div>

							<div class="form-group">
								<select name="genero" class="form-control input-lg" required>
									<option value="" disable selected>Elige tu género</option>
							...
							<div class="form-group">
								<input type="text" name="dni" minlength="8" maxlength="8" class="form-control input-lg"
									placeholder="Dni" required pattern="[0-9]{8}"
									title="El campo solo debe contener dígitos numéricos.">
							</div>

							<div class="form-group">
								<input type="text" name="celular" minlength="9" maxlength="9"
									class="form-control input-lg" placeholder="Celular" required pattern="[0-9]+"
									title="El campo solo debe contener dígitos numéricos.">
							</div>

							<div class="form-group">
								<input type="email" name="correo" maxlength="30" class="form-control input-lg"
									placeholder="Correo" required="">
							</div>

							<div class="form-group">
								<input type="password" name="clave" maxlength="10" class="form-control input-lg"
